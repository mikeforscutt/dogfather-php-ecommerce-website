...
define('LOG_ERRORS_FILE', '\\Applications\\MAMP\\htdocs\\dogfather-ecom\\errors_log.txt'); // Windows
...
define('DB_USERNAME', 'dogfatheradmin');
define('DB_PASSWORD', 'dogfatheradmin');
define('DB_DATABASE', 'dogfather');
...
define('VIRTUAL_LOCATION', '/dogfather-ecom/');
